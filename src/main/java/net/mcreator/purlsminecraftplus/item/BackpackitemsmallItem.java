...
import net.mcreator.purlsminecraftplus.item.inventory.BackpackitemsmallInventoryCapability;

import javax.annotation.Nullable;

import io.netty.buffer.Unpooled;

public class BackpackitemsmallItem extends Item {
	public BackpackitemsmallItem() {
		...
		if (entity instanceof ServerPlayer serverPlayer) {
			NetworkHooks.openScreen(serverPlayer, new MenuProvider() {
				...
				public AbstractContainerMenu createMenu(int id, Inventory inventory, Player player) {
					...
					return new BackpacksmallMenu(id, inventory, packetBuffer);
				}
			}, buf -> {
	...
	public ICapabilityProvider initCapabilities(ItemStack stack, @Nullable CompoundTag compound) {
		return new BackpackitemsmallInventoryCapability();
	}
