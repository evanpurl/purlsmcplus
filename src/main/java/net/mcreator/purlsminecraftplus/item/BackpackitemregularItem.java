...
import net.mcreator.purlsminecraftplus.item.inventory.BackpackitemregularInventoryCapability;

import javax.annotation.Nullable;

import io.netty.buffer.Unpooled;

public class BackpackitemregularItem extends Item {
	public BackpackitemregularItem() {
		...
		if (entity instanceof ServerPlayer serverPlayer) {
			NetworkHooks.openScreen(serverPlayer, new MenuProvider() {
				...
				public AbstractContainerMenu createMenu(int id, Inventory inventory, Player player) {
					...
					return new BackpackregularMenu(id, inventory, packetBuffer);
				}
			}, buf -> {
	...
	public ICapabilityProvider initCapabilities(ItemStack stack, @Nullable CompoundTag compound) {
		return new BackpackitemregularInventoryCapability();
	}
