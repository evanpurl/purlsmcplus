...
package net.mcreator.purlsminecraftplus.world.inventory;
...
public class BackpackregularMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public BackpackregularMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(PurlsMinecraftPlusModMenus.BACKPACKREGULAR.get(), id);
