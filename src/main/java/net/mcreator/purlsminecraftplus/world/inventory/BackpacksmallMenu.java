...
public class BackpacksmallMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public BackpacksmallMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(PurlsMinecraftPlusModMenus.BACKPACKSMALL.get(), id);
